    ...
    >
      ...
      >
        ...
        <a
          href="/CV.pdf"
          download
          className="group bg-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:scale-110 transition active:scale-105 cursor-pointer borderBlack"
        >
          Download CV{" "}
        ...
        <a
          ...
          target="_blank"
          className="bg-white p-4 text-gray-700 flex items-center rounded-full outline-none focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 transition active:scale-105 cursor-pointer borderBlack"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          href="https://www.linkedin.com/in/hernan-hawryluk/"
          target="_blank"
          className="bg-white p-4 text-gray-700 flex items-center rounded-full text-[1.35rem] focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 transition active:scale-105 cursor-pointer borderBlack"
        >
          <BsGithub />
        </a>
      </motion.div>
